...
* Google AIP:
 * [AIP-181](https://google.aip.dev/181) –
 Menetapkan bahwa semua API harus memiliki versi eksplisit yang konsisten dalam URI atau header.
 * [AIP-185](https://google.aip.dev/185) – Release Levels
 Gunakan label tambahan seperti alpha, beta, atau stable untuk menunjukkan tingkat kesiapan fitur:
  - v1alpha1 → Eksperimen, tidak dijamin stabil
  - v1beta1 → Siap diuji publik, masih bisa berubah
  - v1 → Stabil dan didukung penuh
 * [AIP-188](https://google.aip.dev/188) – Consistency Across Versions
 Saat merilis versi baru (v2), endpoint dan resource naming harus konsisten sebisa mungkin agar konsumen mudah migrasi.
 Hindari perubahan drastis pada struktur URI tanpa alasan kuat. Pertahankan semantik field & behavior.
